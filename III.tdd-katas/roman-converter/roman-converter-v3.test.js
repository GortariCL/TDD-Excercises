const {
  ...
  describe("given the function convertToOldRoman", () => {
    ...
    it("given the input 2 when calls the function it will return 'II'", () => {
      // arrange
      const input = 2;
      const expected = "II";
      // act
    ...
    it("given the input 6 when calls the function it will return 'VI'", () => {
      // arrange
      const input = 6;
      const expected = "VI";
      // act
